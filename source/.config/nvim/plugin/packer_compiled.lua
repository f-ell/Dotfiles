...
_G.packer_plugins = {
  ...
  ["markdown-preview.nvim"] = {
    ...
    loaded = true,
    path = "/home/nico/.local/share/nvim/site/pack/packer/start/markdown-preview.nvim",
  ...
  ["vim-table-mode"] = {
    ...
    config = { "\27LJ\2\n6\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\27plugins.vim-table-mode\frequire\0" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
...
try_loadstring("\27LJ\2\n0\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\21plugins.nvim-cmp\frequire\0", "config", "cmp-buffer")
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-lsp-installer', 'cmp-nvim-lua'}, { ft = "lua" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-web-devicons', 'presence.nvim', 'nvim-treesitter', 'nvim-colorizer.lua', 'vim-surround'}, { event = "VimEnter *" }, _G.packer_plugins)]]
