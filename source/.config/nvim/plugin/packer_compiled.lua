...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-colorizer.lua', 'vim-surround', 'nvim-web-devicons', 'nvim-treesitter', 'presence.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
