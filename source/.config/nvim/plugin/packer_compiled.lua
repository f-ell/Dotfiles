...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-web-devicons', 'nvim-colorizer.lua', 'presence.nvim', 'vim-surround'}, { event = "VimEnter *" }, _G.packer_plugins)]]
