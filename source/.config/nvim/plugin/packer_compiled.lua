...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-web-devicons', 'LuaSnip', 'presence.nvim', 'nvim-treesitter', 'vim-surround'}, { event = "VimEnter *" }, _G.packer_plugins)]]
